...
<p align="center">
	<img src="pacman.gif" alt="Pacman" style="display:block;width:100%;height:auto;margin-bottom:48px;border:5px solid var(--link);border-radius:12px;box-sizing:border-box;">
</p>
...
Oltre ai progetti personali, raccolti su [Geoteo](https://geoteo.net) e [GitHub](https://github.com/matteogiorgi?tab=repositories), negli anni ho affiancato lo studio con alcune esperienze formative e professionali.
