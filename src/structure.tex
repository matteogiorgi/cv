...
\geometry{
	hmargin=1.6cm, % Horizontal margin
	vmargin=1.00cm, % Vertical margin originally 1.75cm
...
\setlength\columnsep{0.08\textwidth} % Specify the amount of space between the columns
