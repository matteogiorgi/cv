...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{\href{http://www.area.pi.cnr.it/}{CNR Pisa}}{I had an experience, together with a colleague of mine, as a \textit{Python} programmer inside the \textit{CNR} offices in Pisa}{}
	...
	\tableentry{\href{http://didawiki.di.unipi.it/doku.php/fisica/informatica/201617/start}{Lab assistant}}{I worked together with Professor Pelagatti as lab assistant for the \textit{C} laboratory exam at \textit{B.Sc. in Phisics}}{spaceafter}
	...
	\tableentry{\href{https://www.geoteo.net/config.html}{Dotfiles}}{I am keeping all my \textit{GNU/Linux} scripts and configuration files, written over time, in a public repository so that}{}
	\tableentry{}{everyone can access, change and update quickly their system configuration}{}
