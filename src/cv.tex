...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{}{exploit the \textit{RSA} cryptosystem vulnerabilities with a specific focus on \textit{Wiener Attack} and its use of continued}{}
    ...
    \tableentry{Hackathon}{First place in the 2021 edition of \href{http://contaminationlab.unipi.it/conthackt-foodmobilitydigital}{\textit{ContHackt}}, organized by \textit{University of Pisa} and \textit{Contamination Lab Pisa}. As}{}
    \tableentry{}{winner, our team had access to the 2021/2022 \href{https://eit-hei.eu/app/uploads/2021/10/EIT-Project-Fact-Sheet-EUAcceL.pdf}{\textit{EUAcceL}} project organized by the \textit{European Intitute of Innovation}}{}
    \tableentry{}{\textit{and Tecnology} and won the final stage with a blockchain prototype for the tracking of food products.}{spaceafter}
...
\vspace{15pt}
\section{Competitive sailing}

More than ten years of sailing activity at both national and international level in Optimist, 420 and 470 class, most of which among the ranks of the junior national team. Took part in several prestigious competitions, above all: \href{https://www.kieler-woche.de}{\textit{Kiel Week}} and \href{https://www.barcolana.it}{\textit{Barcolana}} as the two largest sailing event in the world.\\
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{National results}{Ranked first once and qualified among the first ten italian juniores other four times. Among others,}{}
	\tableentry{}{winner of \textit{Young Barcolana}, \textit{Mediterranean Cup} and \textit{Trofeo Accademia Navale Juniores}.}{}
    \tableentry{International results}{Competed, as a member of the italian national team, in one word championship (Qingdao - China),}{}
    \tableentry{}{three european championships (Tavira - Portugal, Dublin - Ireland, Riva dal Garda - Italy) and}{}
    \tableentry{}{classified vice-champion in one european team championship (Berlin - Germany).}{}
