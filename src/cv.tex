...
%			\raisebox{-1pt}{\small\faDesktop} & \href{https://www.LaTeXTemplates.com}{https://www.LaTeXTemplates.com} \\ % Website
			\raisebox{-1pt}{\faGithub} & \href{https://github.com/MatteoGiorgi}{https://github.com/MatteoGiorgi} \\ % GitHub profile
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Avanzato}{C, Java8, Standard ML, Ocaml,}{}
    \tableentry{}{Bash, AWK, MATLAB}{spaceafter}

	
	%------------------------------------------------
	
	\tableentry{Intermedio}{Wolfram Mathematica, Haskell,}{}
    \tableentry{}{Go, Python, Javascript}{spaceafter}
    
    %------------------------------------------------
    
    \tableentry{Base}{Assembly, C++, Scala, Scheme,}{}
    \tableentry{}{Common Lisp, SystemVerilog}{spaceafter}
