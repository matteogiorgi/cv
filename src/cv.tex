...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{}{qualified other three times among the fist ten italian juniores.}{}
    ...
    \tableentry{Running}{I started as a middle-distance runner them moved to long distance, specialising in 10k and half-marathon.}{}
    \tableentry{}{Sometime I took the time to do few ultra-marathon competitions, one over all the \textit{Etna Marathon}: an over 42k long}{}
