...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Dissertation}{Currently writing my B.Sc. dissertation on the use of non-linear programming for portfolio optimization}{}
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Sailing}{I have more than 10 years of sailing activity at both national and international level. I won one national ranking list and}{}
	\tableentry{}{qualified other three times among the first ten italian juniores.}{}
	\tableentry{}{As a member of the italian national team, I competed in 1 word championship, 3 european championships and 1}{}
	\tableentry{}{european team championship (classified as vice-champion).}{}
