...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{}{final mark of 110L/110L}{spaceafter}
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{}{management, C system programming,}{}
	...
	\tableentry{Extra}{Knowledge of \textit{Sql}, \textit{HTML} and \textit{CSS}}{spaceafter}
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{}{writing, \textit{DELF A2} certification}{spaceafter}
...
\medskip
I worked together with Professor Pelagatti as lab assistent for the \href{http://didawiki.di.unipi.it/doku.php/fisica/informatica/201617/start}{C laboratory exam} at \textit{B.Sc. in Phisics}.

\medskip
Under the supervision of Professor Romani from \textit{UniPi}, I wrote \href{https://www.geoteo.net/attack.html}{a paper} regarding the attacks that exploit the \textit{RSA} cryptosystem vulnerabilities. I focused specifically on \textit{Wiener Attack} and its use of continued fractions for the factorization of the \textit{RSA} module.
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{}{\textit{juniores}; plus I took part in the two largest sailing event in the world: \textit{Kiel Week} and \textit{Barcolana}.}{spaceafter}
    ...
    \tableentry{}{race at 3000m msl on the volcano Etna.}{spaceafter}
