...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{}{Bachelor of Science in Computer Science at the }{}
    \tableentry{}{\textit{University of Pisa} summa cum laude (110L/110)}{}
...
I am very keen on programming languages and I often find myself playing with a new language trying to improve my skills; this has made me focused on \textit{Functional Programming}, experimenting with languages such as \textit{Ocaml} and \textit{Haskell}.
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
    ...
    \tableentry{}{\textit{Scheme}, \textit{Ocaml}, \textit{Haskell}, \textit{Bash}, \textit{Awk}}{spaceafter}
...
\begin{supertabular}{rl} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{PDE}{\href{https://github.com/matteogiorgi/pde-conf}{Public repository} of all my \textit{GNU/Linux} scripts and config. files, written over time. The main purpose of the}{}
